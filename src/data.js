...
export const supplements = [
  ...
  },
  {
    ...
    when: 'Morning with breakfast',
    why: 'The Ryzen formula - superfood that worked for kuya!',
    icon: '🌿',
    timesPerDay: 1,
    defaultTimes: ['08:00'],
    bottleSize: 120,
    ...
    explanation: 'Ito ang secret weapon ni Ryzen! Chlorella ang ginagamit ni Naomi nung buntis kay Ryzen at matino ang lumabas. Sun Chlorella ay premium brand na may pulverized cell wall para sa better absorption. 120 tablets ÷ 3/day = 40 days supply.',
...
export const moneyTracker = [
  ...
  },
  {
    ...
    where: 'Shinji\'s employer HR department\nNaomi\'s employer HR department\nYour health insurance association (健保組合 / kenpokumiai)',
    bring: 'Just ask them! They will tell you the process.',
    deadline: 'Ask early during pregnancy so you know what to expect',
    tip: 'Only for employer insurance (社会保険 / shakai hoken), NOT National Health Insurance (国保 / kokuho). Check BOTH Shinji\'s and Naomi\'s employers. This is FREE EXTRA MONEY just for asking.',
    phones: []
  },
  {
    id: 'm8',
...
export const taglishTips = [
  ...
  "Ang chlorella ay superfood ni Ryzen! Continue the winning formula para sa baby #2.",
