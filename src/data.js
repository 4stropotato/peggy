...
export const supplements = [
  {
    ...
    perDose: 3,
    price: 4149,
    note: 'Take 3 capsules with food. This serving includes high iron, so avoid adding extra iron unless OB-GYN confirms deficiency.',
...
export const taglishTips = [
  ...
  "Chlorella is optional lang. If may kabag or upset tummy, pause muna and ask OB-GYN.",
...
export const optimalSchedule = [
  {
    ...
    note: 'Take with food that has fat (eggs, avocado). Keep this as the core morning stack.',
